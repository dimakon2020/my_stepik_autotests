...
try:
    ...
    input3.send_keys("Ivanovo")
    input4 = browser.find_element_by_css_selector(".second_block > .first_class > .form-control")
    input4.send_keys("Russia")
    input5 = browser.find_element_by_css_selector(".second_block > .second_class > .form-control")
